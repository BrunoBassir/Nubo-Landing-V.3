...
import { Gift, Gavel, RefreshCw, PawPrint, FlaskConical, Sparkles, Store, Plus, Rocket, Star, Compass, AtSign, ArrowRight, Camera, Music, MapPin, Search, CheckCircle2 } from 'lucide-react';
        ...
        <ScrollReveal>
          <div className="grid md:grid-cols-12 gap-10">
            <div className="md:col-span-5">
              ...
              <div className="mt-6 p-4 rounded-2xl bg-bgDark/50 border border-white/5 backdrop-blur-sm">
                <div className="label-caps text-onSurfaceVariant mb-2">CONTACTO</div>
                <a href="mailto:hola@nubo.travel?subject=Hola%20Nubo" className="inline-flex items-center gap-3 group mb-2">
                ...
                }} className="flex gap-2 max-w-sm mt-1 focus-within:ring-2 ring-primary/20 rounded-xl transition-shadow">
              ...
              {[
                ...
                <div key={g.t}>
                  ...
                  <ul className="space-y-3">
                    {g.l.map(it => (
                      <li key={it}>
                        <a href="#" className="text-sm text-onSurfaceVariant hover:text-white hover:text-shadow-[0_0_8px_rgba(255,255,255,0.5)] transition-all flex items-center group">
